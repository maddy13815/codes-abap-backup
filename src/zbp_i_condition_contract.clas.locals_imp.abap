CLASS lhc_ZI_CONDITION_CONTRACT DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR zi_condition_contract RESULT result.

    METHODS create FOR MODIFY
      IMPORTING entities FOR CREATE zi_condition_contract.

    METHODS update FOR MODIFY
      IMPORTING entities FOR UPDATE zi_condition_contract.

    METHODS delete FOR MODIFY
      IMPORTING keys FOR DELETE zi_condition_contract.

    METHODS read FOR READ
      IMPORTING keys FOR READ zi_condition_contract RESULT result.

    METHODS lock FOR LOCK
      IMPORTING keys FOR LOCK zi_condition_contract.

ENDCLASS.

CLASS lhc_ZI_CONDITION_CONTRACT IMPLEMENTATION.
...
*             cndn_contr_worker_cost_cen TYPE c LENGTH 10,
    ...
    ls_payload-cndn_contr_type = 'Z001'.
    ls_payload-customer = '10000059'.
    ls_payload-supplier = ''.
    ls_payload-sales_organization = 'ZUS1'.
    ls_payload-distribution_channel = '01'.
    ls_payload-division = '00'.
    ls_payload-amount_field_group = '0S01'.
...
CLASS lsc_ZI_CONDITION_CONTRACT DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_CONDITION_CONTRACT IMPLEMENTATION.
